...
void UpdateControls() {
	...
	//how can i smooth the knob values
	//knobValues[0] = knobValues[0] * 0.9 + hw.GetKnobValue( DaisyPatch::CTRL_1 ) * 0.1;
...
void UpdateScreen() {
	...
	//how can i draw a circle on the display
	//hw.display.DrawCircle(64, 32, 10, true);
